    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] pt-32 pb-20">
            <div className="max-w-2xl mx-auto px-4">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#C9A84C]/30 bg-[#C9A84C]/10 mb-4">
                    ...
                    <h1 className="text-4xl font-bold text-[#0B1F3A] mb-3">Apply Now</h1>
