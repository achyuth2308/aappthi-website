  ...
  return baseLayout(`
    ...
    <div style="background:#f8f9fa;border-left:4px solid ${BRAND_COLOR};padding:16px 20px;border-radius:0 8px 8px 0;margin:0 0 24px;">
      ...
      <ul style="margin:8px 0 0;padding-left:18px;color:#666;font-size:13px;line-height:1.8;">
        ...
        <li>Final decision (Approved/Rejected)</li>
      </ul>
    </div>
    <p style="color:#999;font-size:13px;margin:0;">
      If you have any questions, contact us at <a href="mailto:hr@aapthisolutions.com" style="color:${BRAND_COLOR};">hr@aapthisolutions.com</a>.
    </p>
  `);
}
...
export function statusUpdatedHTML(name, status, position) {
  ...
  return baseLayout(`
    ...
    <p style="color:#999;font-size:13px;margin:0;">
      For queries, contact <a href="mailto:hr@aapthisolutions.com" style="color:${BRAND_COLOR};">hr@aapthisolutions.com</a>.
    </p>
  `);
}
...
export function contactReplyHTML(name, originalMessage, replyMessage) {
  return baseLayout(`
    ...
    <p style="color:#999;font-size:13px;margin:0;">
      For further queries, contact <a href="mailto:hr@aapthisolutions.com" style="color:${BRAND_COLOR};">hr@aapthisolutions.com</a>.
    </p>
  `);
}
